...
void fetch_function__LedStatus__led_status(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const bool *>(
    get_const_function__LedStatus__led_status(untyped_member, index));
  auto & value = *reinterpret_cast<bool *>(untyped_value);
  value = item;
}

void assign_function__LedStatus__led_status(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<bool *>(
    get_function__LedStatus__led_status(untyped_member, index));
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LedStatus_message_member_array[1] = {
  {
    ...
    size_function__LedStatus__led_status,  // size() function pointer
    get_const_function__LedStatus__led_status,  // get_const(index) function pointer
