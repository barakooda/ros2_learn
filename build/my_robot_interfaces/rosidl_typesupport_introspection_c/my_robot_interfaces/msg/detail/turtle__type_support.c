...
static rosidl_typesupport_introspection_c__MessageMember my_robot_interfaces__msg__Turtle__rosidl_typesupport_introspection_c__Turtle_message_member_array[3] = {
  {
    "name",  // name
