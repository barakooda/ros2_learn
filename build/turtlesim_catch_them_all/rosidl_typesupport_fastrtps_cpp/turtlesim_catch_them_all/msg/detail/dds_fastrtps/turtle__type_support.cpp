...
#include "turtlesim_catch_them_all/msg/detail/turtle__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtlesim_catch_them_all::msg::Turtle;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const turtlesim_catch_them_all::msg::Turtle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtlesim_catch_them_all::msg::Turtle *>(
    untyped_ros_message);
...
{
  return &turtlesim_catch_them_all::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
